...
public class Program implements java.io.Serializable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Program) {
            ...
            return (this.startAddress == that.startAddress && this.instructions.equals(that.instructions));
        }
        return false;
    }
    ...
    public void install(Instruction i) {
        if (DEBUG) {
            System.out.println("Installing " + i.getDescription() + " at " + instructions.size());
        }
        instructions.add(i);
    }
    ...
    public void install(int loc, Instruction i) {
        if (DEBUG) {
            System.out.println("Installing " + i.getDescription() + " at " + loc);
        }
    ...
    public void install(int jump) {
        if (DEBUG) {
            System.out.println("Installing " + jump + " at " + instructions.size());
        }
